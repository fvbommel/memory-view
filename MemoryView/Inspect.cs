...
{
    public static MemoryGraph CreateGraph<T>(
        T root,
    ...
    public static MemoryGraph CreateGraph<T1, T2>(
        T1 root1,
        T2 root2,
    ...
    public static MemoryGraph CreateGraph<T1, T2, T3>(
        T1 root1,
        T2 root2,
        T3 root3,
        [CallerArgumentExpression("root1")] string? name1 = null,
    ...
    public static MemoryGraph CreateGraph<T1, T2, T3, T4>(
        T1 root1,
        T2 root2,
        T3 root3,
        T4 root4,
    ...
    public static MemoryGraph CreateGraph<T1, T2, T3, T4, T5>(
        T1 root1,
        T2 root2,
        T3 root3,
        T4 root4,
